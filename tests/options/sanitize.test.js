...
describe('Expect package (sanitization):', () => {
  ...
  it('sanitizes part of a text with several allowed characters', () => {
    ...
    expect(sanitized).toBe(
      'Some basic math like 1 + 2 = 3 should be allowed&excl; :&rpar;'
    );
  });
  ...
  it('sanitizes strings with surrogate pairs correctly in strict mode', () => {
    ...
    expect(sanitized).toBe(
      '&lt;p&gt;&quot;Japanese&quot; in japanese is 日本語&excl;&lt;/p&gt;'
    );
  });
  ...
  it('can sanitize a longer string with multiple entities', () => {
    const sanitized = util.sanitize({
      value:
        '<div class="test" data-someattribute="hello">Wow, this sure will get sanitized!</div>',
      strict: true
    });
    expect(sanitized).toBe(
      '&lt;div class&equals;&quot;test&quot; data-someattribute&equals;&quot;hello&quot;&gt;Wow, this sure will get sanitized&excl;&lt;/div&gt;'
    );
  });
});
